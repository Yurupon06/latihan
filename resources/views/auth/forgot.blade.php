    ...
    <div class="login-page">
        <form method="POST" action="{{ route('email.search') }}">
            ...
            <div class="form">
                ...
                <p class="message">Back To <a href="{{ route('login') }}">Login</a></p>
            </div>
        </form>
    </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="modal-body">
                        <input type="email" name="email" id="reset-email" value="{{ session('email') }}" readonly class="form-control mb-3" placeholder="Email Address">
                        <input type="password" name="password" id="password" class="form-control mb-3" placeholder="New Password" required>
                        <input type="password" name="password_confirmation" id="password_confirmation" class="form-control mb-3" placeholder="Confirm Password" required>
                    </div>
