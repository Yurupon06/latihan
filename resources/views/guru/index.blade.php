          ...
          <div class="col-12">
            <div class="card mb-4">
              <div class="card-header pb-0">
                <a class="btn btn-primary" href="{{ route('guru.create')}}"><span>add new item</span></a>
              </div>
                  ...
                  <table class="table align-items-center mb-0" id="datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <img src="storage/{{ $dt->foto }}" class="img-thumbnail" alt="" style="max-width: 100px; max-height: 100px;">
                        </td>
                        <td class="align-middle text-center text-sm">
                          <a href="{{ route('guru.edit', $dt->id) }}">
                              <button class="btn btn-success"><span class="badge badge-sm bg-gradient-success">Edit</span></button>
                          </a>
                          <form action="{{ route('guru.destroy', $dt->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
